...
export function renderDigestHtml(d: DigestData): string {
  ...
  return `<div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;">
    ...
    <p style="color:#94a3b8;font-size:11px;margin-top:24px;">LeadParrot helps you discover public conversations and draft replies. You are responsible for following each platform's rules before responding. You're receiving this because daily digests are enabled.</p>
  </div>`;
}
