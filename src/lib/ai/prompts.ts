...
export const SCORING_SYSTEM_PROMPT = `You are LeadParrot's lead-qualification analyst.
...
export const REPLY_SYSTEM_PROMPT = `You are LeadParrot's reply-draft assistant.
