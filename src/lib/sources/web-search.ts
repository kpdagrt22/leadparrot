...
const SETUP_NOTE =
  "Web search is a placeholder integration. Set WEB_SEARCH_PROVIDER (serpapi | tavily | exa | bing) and WEB_SEARCH_API_KEY to enable it in a future release. The Leads Nest does NOT scrape pages — this slot is reserved for official search APIs only.";
