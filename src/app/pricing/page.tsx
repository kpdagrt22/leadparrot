...
const FAQS = [
  ...
  { q: "Do you auto-post replies?", a: "Never. LeadParrot only drafts replies you copy and post yourself." },
      ...
      <section className="border-b border-ink-200 bg-gradient-to-b from-brand-50/60 to-white py-16">
        <div className="container-page text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-ink-600">
            Start free. Upgrade when LeadParrot is finding you real opportunities. No contracts, cancel anytime.
          </p>
        </div>
      </section>
